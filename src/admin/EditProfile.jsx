    ...
    <div className='mt-32 flex justify-center items-center'>
      <div className='border-2 border-[#242234] flex flex-col w-[500px] h-wrap p-5 rounded-2xl mb-5'>
          ...
          <form onSubmit={handleUpdate} action="" className='flex flex-col mt-5 gap-3 '>
              ...
              <input type="email" name="email" id="" disabled className='p-2 border border-[#242234] w-full focus:outline-none focus:border-2'  value={email} onChange={(e)=> setEmail(e.target.value)} />
...
export default EditPoliceProfile